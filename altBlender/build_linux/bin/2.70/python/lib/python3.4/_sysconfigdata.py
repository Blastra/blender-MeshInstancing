...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'AR': 'ar',
 'ARFLAGS': 'rc',
 'ASDLGEN': '@echo python: not-found! cannot run ./Parser/asdl_c.py # '
            './Parser/asdl_c.py',
 ...
 'CC': 'gcc -pthread',
 'CCSHARED': '-fPIC',
 'CFLAGS': '-Wno-unused-result -Werror=declaration-after-statement '
           '-DDYNAMIC_ANNOTATIONS_ENABLED=1 -DNDEBUG -g -fwrapv -O3 -Wall '
           '-Wstrict-prototypes -march=x86-64 -mtune=generic -O2 -pipe '
           '-fstack-protector --param=ssp-buffer-size=4 -march=x86-64 '
 ...
 'CONFIG_ARGS': "'--prefix=/usr' '--enable-shared' '--with-threads' "
                "'--with-computed-gotos' '--enable-ipv6' '--with-valgrind' "
 ...
 'COVERAGE_INFO': '/build/python/src/Python-3.4.0/coverage.info',
 'COVERAGE_REPORT': '/build/python/src/Python-3.4.0/lcov-report',
 ...
 'LIBDIR': '/usr/lib',
 'LIBFFI_INCLUDEDIR': '/usr/lib/libffi-3.0.13/include',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 ...
 'OPCODETARGETS_H': '\\',
 'OPT': '-DDYNAMIC_ANNOTATIONS_ENABLED=1 -DNDEBUG -g -fwrapv -O3 -Wall '
        '-Wstrict-prototypes',
 'OTHER_LIBTOOL_OPT': '',
 'PACKAGE_BUGREPORT': 0,
 'PACKAGE_NAME': 0,
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/build/python/src/Python-3.4.0:',
 'SCRIPTDIR': '/usr/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '',
 'SHELL': '/bin/sh',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/build/python/src/Python-3.4.0: ./python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/build/python/src/Python-3.4.0: ./python '
 ...
 'abs_builddir': '/build/python/src/Python-3.4.0',
 'abs_srcdir': '/build/python/src/Python-3.4.0',
