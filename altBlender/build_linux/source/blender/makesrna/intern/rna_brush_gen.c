...
BoolPropertyRNA rna_Brush_use_drag_dot;
...
BoolPropertyRNA rna_SculptToolCapabilities_has_strength;
...
int Brush_use_drag_dot_get(PointerRNA *ptr)
{
	Brush *data = (Brush *)(ptr->data);
	return (((data->flag) & 8388608) != 0);
}

void Brush_use_drag_dot_set(PointerRNA *ptr, int value)
{
	Brush *data = (Brush *)(ptr->data);
...
{
	return rna_Sculpt_sculpt_tool_capabilities_get(ptr);
}
...
int SculptToolCapabilities_has_strength_get(PointerRNA *ptr)
{
	return rna_SculptToolCapabilities_has_strength_get(ptr);
}
...
EnumPropertyRNA rna_Brush_blend = {
	...
	0, -1, NULL},
	Brush_blend_get, Brush_blend_set, NULL, NULL, NULL, NULL, rna_Brush_blend_items, 8, 0
};
...
static EnumPropertyItem rna_Brush_image_tool_items[5] = {
	{0, "DRAW", 806, "Draw", ""},
	{1, "SOFTEN", 804, "Soften", ""},
	{2, "SMEAR", 801, "Smear", ""},
	{3, "CLONE", 785, "Clone", ""},
...
EnumPropertyRNA rna_Brush_image_tool = {
	...
	0, -1, NULL},
	Brush_image_tool_get, Brush_image_tool_set, NULL, NULL, NULL, NULL, rna_Brush_image_tool_items, 4, 0
};
...
EnumPropertyRNA rna_Brush_stroke_method = {
	...
	rna_Brush_update, 0, NULL, NULL,
	0, -1, NULL},
	Brush_stroke_method_get, Brush_stroke_method_set, rna_Brush_stroke_itemf, NULL, NULL, NULL, rna_Brush_stroke_method_items, 5, 0
};
...
IntPropertyRNA rna_Brush_spacing = {
	{(PropertyRNA *)&rna_Brush_smooth_stroke_radius, (PropertyRNA *)&rna_Brush_jitter_absolute,
...
IntPropertyRNA rna_Brush_smooth_stroke_radius = {
	{(PropertyRNA *)&rna_Brush_smooth_stroke_factor, (PropertyRNA *)&rna_Brush_spacing,
...
FloatPropertyRNA rna_Brush_color = {
	{(PropertyRNA *)&rna_Brush_weight, (PropertyRNA *)&rna_Brush_rate,
	-1, "color", 8195, "Color",
	"",
	0, "*",
...
FloatPropertyRNA rna_Brush_weight = {
	{(PropertyRNA *)&rna_Brush_strength, (PropertyRNA *)&rna_Brush_color,
...
FloatPropertyRNA rna_Brush_mask_stencil_dimension = {
	{(PropertyRNA *)&rna_Brush_use_airbrush, (PropertyRNA *)&rna_Brush_mask_stencil_pos,
...
BoolPropertyRNA rna_Brush_use_airbrush = {
	{(PropertyRNA *)&rna_Brush_use_original_normal, (PropertyRNA *)&rna_Brush_mask_stencil_dimension,
...
BoolPropertyRNA rna_Brush_use_pressure_size = {
	{(PropertyRNA *)&rna_Brush_use_pressure_jitter, (PropertyRNA *)&rna_Brush_use_offset_pressure,
...
BoolPropertyRNA rna_Brush_use_pressure_spacing = {
	{(PropertyRNA *)&rna_Brush_use_inverse_smooth_pressure, (PropertyRNA *)&rna_Brush_use_pressure_jitter,
...
BoolPropertyRNA rna_Brush_use_inverse_smooth_pressure = {
	{(PropertyRNA *)&rna_Brush_use_rake, (PropertyRNA *)&rna_Brush_use_pressure_spacing,
...
BoolPropertyRNA rna_Brush_use_space = {
	{(PropertyRNA *)&rna_Brush_use_smooth_stroke, (PropertyRNA *)&rna_Brush_use_anchor,
	-1, "use_space", 3, "Space",
...
BoolPropertyRNA rna_Brush_use_smooth_stroke = {
	{(PropertyRNA *)&rna_Brush_use_persistent, (PropertyRNA *)&rna_Brush_use_space,
...
BoolPropertyRNA rna_Brush_use_edge_to_edge = {
	{(PropertyRNA *)&rna_Brush_use_drag_dot, (PropertyRNA *)&rna_Brush_use_locked_size,
...
BoolPropertyRNA rna_Brush_use_drag_dot = {
	...
	-1, "use_drag_dot", 3, "Restore Mesh",
	"Allow a single dot to be carefully positioned",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Brush_update, 0, NULL, NULL,
	0, -1, NULL},
	Brush_use_drag_dot_get, Brush_use_drag_dot_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

BoolPropertyRNA rna_Brush_use_alpha = {
	{(PropertyRNA *)&rna_Brush_curve, (PropertyRNA *)&rna_Brush_use_drag_dot,
	-1, "use_alpha", 3, "Alpha",
...
PointerPropertyRNA rna_Brush_curve = {
	{(PropertyRNA *)&rna_Brush_use_primary_overlay, (PropertyRNA *)&rna_Brush_use_alpha,
...
BoolPropertyRNA rna_Brush_use_primary_overlay = {
	{(PropertyRNA *)&rna_Brush_use_secondary_overlay, (PropertyRNA *)&rna_Brush_curve,
...
PointerPropertyRNA rna_Brush_sculpt_capabilities = {
	{NULL, (PropertyRNA *)&rna_Brush_brush_capabilities,
...
StructRNA RNA_Brush = {
	...
	NULL,
	{(PropertyRNA *)&rna_Brush_blend, (PropertyRNA *)&rna_Brush_sculpt_capabilities}},
...
BoolPropertyRNA rna_BrushCapabilities_has_spacing = {
	{NULL, (PropertyRNA *)&rna_BrushCapabilities_has_texture_angle_source,
...
StructRNA RNA_BrushCapabilities = {
	...
	NULL,
	{(PropertyRNA *)&rna_BrushCapabilities_rna_properties, (PropertyRNA *)&rna_BrushCapabilities_has_spacing}},
...
BoolPropertyRNA rna_SculptToolCapabilities_has_space_attenuation = {
	{(PropertyRNA *)&rna_SculptToolCapabilities_has_strength, (PropertyRNA *)&rna_SculptToolCapabilities_has_smooth_stroke,
...
BoolPropertyRNA rna_SculptToolCapabilities_has_strength = {
	...
	-1, "has_strength", 2, "Has Strength",
	NULL,
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	SculptToolCapabilities_has_strength_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

BoolPropertyRNA rna_SculptToolCapabilities_has_gravity = {
	{NULL, (PropertyRNA *)&rna_SculptToolCapabilities_has_strength,
...
StructRNA RNA_SculptToolCapabilities = {
	{(ContainerRNA *)&RNA_BrushTextureSlot, (ContainerRNA *)&RNA_BrushCapabilities,
	NULL,
...
StructRNA RNA_BrushTextureSlot = {
	{(ContainerRNA *)&RNA_OperatorStrokeElement, (ContainerRNA *)&RNA_SculptToolCapabilities,
	NULL,
...
FloatPropertyRNA rna_OperatorStrokeElement_pressure = {
	{(PropertyRNA *)&rna_OperatorStrokeElement_pen_flip, (PropertyRNA *)&rna_OperatorStrokeElement_mouse,
...
BoolPropertyRNA rna_OperatorStrokeElement_pen_flip = {
	{(PropertyRNA *)&rna_OperatorStrokeElement_time, (PropertyRNA *)&rna_OperatorStrokeElement_pressure,
