...
static EnumPropertyItem rna_SpaceImageEditor_pivot_point_items[4] = {
...
EnumPropertyRNA rna_SpaceImageEditor_pivot_point = {
	...
	NULL, 251920384, NULL, NULL,
	0, -1, NULL},
	SpaceImageEditor_pivot_point_get, SpaceImageEditor_pivot_point_set, NULL, NULL, NULL, NULL, rna_SpaceImageEditor_pivot_point_items, 3, 0
};
...
BoolPropertyRNA rna_SpaceUVEditor_show_other_objects = {
	{(PropertyRNA *)&rna_SpaceUVEditor_show_normalized_coords, (PropertyRNA *)&rna_SpaceUVEditor_show_modified_edges,
...
BoolPropertyRNA rna_SpaceUVEditor_show_normalized_coords = {
	{(PropertyRNA *)&rna_SpaceUVEditor_show_faces, (PropertyRNA *)&rna_SpaceUVEditor_show_other_objects,
...
FloatPropertyRNA rna_SpaceView3D_grid_scale = {
	...
	SpaceView3D_grid_scale_get, SpaceView3D_grid_scale_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, FLT_MAX, 0.0f, FLT_MAX, 10.0f, 3, 1.0f, NULL
};
...
static EnumPropertyItem rna_SpaceView3D_transform_manipulators_items[4] = {
	{1, "TRANSLATE", 572, "Manipulator Translate", "Use the manipulator for movement transformations"},
	{2, "ROTATE", 573, "Manipulator Rotate", "Use the manipulator for rotation transformations"},
	{4, "SCALE", 574, "Manipulator Scale", "Use the manipulator for scale transformations"},
	{0, NULL, 0, NULL, NULL}
};
...
EnumPropertyRNA rna_SpaceView3D_matcap_icon = {
	...
	0, -1, NULL},
	SpaceView3D_matcap_icon_get, SpaceView3D_matcap_icon_set, NULL, NULL, NULL, NULL, rna_SpaceView3D_matcap_icon_items, 24, 810
};
