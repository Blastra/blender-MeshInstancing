...
{
	ClothSimSettings *data = (ClothSimSettings *)(ptr->data);
	data->preroll = CLAMPIS(value, 0, 300000);
}
...
FloatPropertyRNA rna_ClothSettings_collider_friction = {
	{(PropertyRNA *)&rna_ClothSettings_mass, (PropertyRNA *)&rna_ClothSettings_internal_friction,
...
FloatPropertyRNA rna_ClothSettings_mass = {
	{(PropertyRNA *)&rna_ClothSettings_vertex_group_mass, (PropertyRNA *)&rna_ClothSettings_collider_friction,
	-1, "mass", 8195, "Mass",
...
FloatPropertyRNA rna_ClothSettings_shrink_max = {
	{(PropertyRNA *)&rna_ClothSettings_use_stiffness_scale, (PropertyRNA *)&rna_ClothSettings_shrink_min,
...
BoolPropertyRNA rna_ClothSettings_use_stiffness_scale = {
	{(PropertyRNA *)&rna_ClothSettings_spring_damping, (PropertyRNA *)&rna_ClothSettings_shrink_max,
...
FloatPropertyRNA rna_ClothSettings_bending_stiffness_max = {
	{(PropertyRNA *)&rna_ClothSettings_use_sewing_springs, (PropertyRNA *)&rna_ClothSettings_bending_stiffness,
...
BoolPropertyRNA rna_ClothSettings_use_sewing_springs = {
	{(PropertyRNA *)&rna_ClothSettings_vertex_group_bending, (PropertyRNA *)&rna_ClothSettings_bending_stiffness_max,
...
PointerPropertyRNA rna_ClothSettings_effector_weights = {
	{(PropertyRNA *)&rna_ClothSettings_pre_roll, (PropertyRNA *)&rna_ClothSettings_vertex_group_bending,
...
IntPropertyRNA rna_ClothSettings_pre_roll = {
	{(PropertyRNA *)&rna_ClothSettings_rest_shape_key, (PropertyRNA *)&rna_ClothSettings_effector_weights,
	...
	ClothSettings_pre_roll_get, ClothSettings_pre_roll_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
	0, 300000, 0, 300000, 1, 0, NULL
};

PointerPropertyRNA rna_ClothSettings_rest_shape_key = {
	{NULL, (PropertyRNA *)&rna_ClothSettings_pre_roll,
...
StructRNA RNA_ClothSettings = {
	{(ContainerRNA *)&RNA_ClothCollisionSettings, (ContainerRNA *)&RNA_Camera,
	NULL,
...
FloatPropertyRNA rna_ClothCollisionSettings_friction = {
	{(PropertyRNA *)&rna_ClothCollisionSettings_collision_quality, (PropertyRNA *)&rna_ClothCollisionSettings_distance_min,
...
IntPropertyRNA rna_ClothCollisionSettings_collision_quality = {
	{(PropertyRNA *)&rna_ClothCollisionSettings_use_self_collision, (PropertyRNA *)&rna_ClothCollisionSettings_friction,
