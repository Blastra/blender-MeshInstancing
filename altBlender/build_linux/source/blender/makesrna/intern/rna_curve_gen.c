...
void Curve_transform(struct Curve *_self, float matrix[16])
{
	rna_Curve_transform(_self, matrix);
}
...
void rna_Curve_transform(struct Curve *_self, float matrix[16]);
...
FunctionRNA rna_Curve_transform_func = {
	{NULL, NULL,
	NULL,
	{(PropertyRNA *)&rna_Curve_transform_matrix, (PropertyRNA *)&rna_Curve_transform_matrix}},
...
StructRNA RNA_Curve = {
	...
	NULL,
	rna_ID_idprops,
	{(FunctionRNA *)&rna_Curve_transform_func, (FunctionRNA *)&rna_Curve_transform_func}
};
