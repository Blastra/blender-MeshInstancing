...
void ParticleSystem_mcol_on_emitter(struct ParticleSystem *_self, struct ParticleSystemModifierData *modifier, struct ParticleData *particle, int particle_no, int vcol_no, float mcol[3])
{
	rna_ParticleSystem_mcol_on_emitter(_self, modifier, particle, particle_no, vcol_no, mcol);
}
...
void rna_ParticleSystem_mcol_on_emitter(struct ParticleSystem *_self, struct ParticleSystemModifierData *modifier, struct ParticleData *particle, int particle_no, int vcol_no, float mcol[3]);
...
FunctionRNA rna_ParticleSystem_mcol_on_emitter_func = {
	...
	"mcol_on_emitter", 0, "Obtain mcol for all particles",
...
BoolPropertyRNA rna_ParticleSettings_use_dynamic_rotation = {
	...
	"Particle rotations are effected by collisions and effectors",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Particle_reset, 0, NULL, NULL,
	0, -1, NULL},
