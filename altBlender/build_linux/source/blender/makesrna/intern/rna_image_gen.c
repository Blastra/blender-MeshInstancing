...
IntPropertyRNA rna_Image_render_slot;
...
int Image_render_slot_get(PointerRNA *ptr)
{
	Image *data = (Image *)(ptr->data);
	return (int)(data->render_slot);
}

void Image_render_slot_set(PointerRNA *ptr, int value)
{
	Image *data = (Image *)(ptr->data);
	data->render_slot = CLAMPIS(value, 0, 7);
}
...
void Image_save(struct Image *_self, ReportList *reports)
{
...
void Image_pack(struct Image *_self, ReportList *reports, int as_png)
{
	rna_Image_pack(_self, reports, as_png);
}
...
void rna_Image_pack(struct Image *_self, ReportList *reports, int as_png);
...
static EnumPropertyItem rna_Image_file_format_items[20] = {
	{0, "", 0, "Image", NULL},
...
BoolPropertyRNA rna_Image_use_generated_float = {
	{(PropertyRNA *)&rna_Image_mapping, (PropertyRNA *)&rna_Image_generated_height,
...
IntPropertyRNA rna_Image_bindcode = {
	{(PropertyRNA *)&rna_Image_render_slot, (PropertyRNA *)&rna_Image_use_clamp_y,
...
IntPropertyRNA rna_Image_render_slot = {
	...
	-1, "render_slot", 8195, "Render Slot",
	"The current render slot displayed, only for viewer type images",
	0, "*",
	PROP_INT, PROP_UNSIGNED | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 171114496, NULL, NULL,
	offsetof(Image, render_slot), 1, NULL},
	Image_render_slot_get, Image_render_slot_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
	0, 7, 0, 7, 1, 0, NULL
};

BoolPropertyRNA rna_Image_has_data = {
	{(PropertyRNA *)&rna_Image_depth, (PropertyRNA *)&rna_Image_render_slot,
...
FunctionRNA rna_Image_save_func = {
	...
	NULL,
	{NULL, NULL}},
	"save", 16, "Save image to its source path",
	Image_save_call,
	NULL
};
...
FunctionRNA rna_Image_pack_func = {
	...
	"pack", 16, "Pack an image as embedded data into the .blend file",
	Image_pack_call,
	NULL
};
...
StructRNA RNA_Image = {
	{(ContainerRNA *)&RNA_ImageUser, (ContainerRNA *)&RNA_GroupObjects,
	NULL,
