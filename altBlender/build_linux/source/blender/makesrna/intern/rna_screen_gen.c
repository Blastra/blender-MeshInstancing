...
BoolPropertyRNA rna_Screen_use_play_3d_editors = {
	{(PropertyRNA *)&rna_Screen_use_play_animation_editors, (PropertyRNA *)&rna_Screen_use_play_top_left_3d_editor,
...
BoolPropertyRNA rna_Screen_use_play_animation_editors = {
	{(PropertyRNA *)&rna_Screen_use_play_properties_editors, (PropertyRNA *)&rna_Screen_use_play_3d_editors,
...
StructRNA RNA_Screen = {
	{(ContainerRNA *)&RNA_Area, (ContainerRNA *)&RNA_Linesets,
	NULL,
...
StructRNA RNA_View2D = {
	{(ContainerRNA *)&RNA_Paint, (ContainerRNA *)&RNA_Region,
	NULL,
