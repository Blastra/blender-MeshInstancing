...
FloatPropertyRNA rna_BevelModifier_profile = {
	{NULL, (PropertyRNA *)&rna_BevelModifier_offset_type,
...
StructRNA RNA_BevelModifier = {
	...
	NULL,
	{(PropertyRNA *)&rna_BevelModifier_width, (PropertyRNA *)&rna_BevelModifier_profile}},
...
BoolPropertyRNA rna_SolidifyModifier_use_flip_normals = {
	{NULL, (PropertyRNA *)&rna_SolidifyModifier_invert_vertex_group,
...
StructRNA RNA_SolidifyModifier = {
	...
	NULL,
	{(PropertyRNA *)&rna_SolidifyModifier_thickness, (PropertyRNA *)&rna_SolidifyModifier_use_flip_normals}},
