...
void Lattice_transform(struct Lattice *_self, float matrix[16])
{
	rna_Lattice_transform(_self, matrix);
}
...
void rna_Lattice_transform(struct Lattice *_self, float matrix[16]);
...
FunctionRNA rna_Lattice_transform_func = {
	{NULL, NULL,
	NULL,
	{(PropertyRNA *)&rna_Lattice_transform_matrix, (PropertyRNA *)&rna_Lattice_transform_matrix}},
