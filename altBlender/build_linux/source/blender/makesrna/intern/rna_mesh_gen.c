...
void Mesh_transform(struct Mesh *_self, float matrix[16])
{
	rna_Mesh_transform(_self, matrix);
}
...
void rna_Mesh_transform(struct Mesh *_self, float matrix[16]);
...
FunctionRNA rna_Mesh_validate_func = {
	{NULL, (FunctionRNA *)&rna_Mesh_unit_test_compare_func,
	NULL,
