...
IntPropertyRNA rna_Material_active_texture_index = {
	{(PropertyRNA *)&rna_Material_use_textures, (PropertyRNA *)&rna_Material_active_texture,
...
BoolPropertyRNA rna_Material_use_textures = {
	{(PropertyRNA *)&rna_Material_diffuse_color, (PropertyRNA *)&rna_Material_active_texture_index,
...
EnumPropertyRNA rna_Material_diffuse_shader = {
	{(PropertyRNA *)&rna_Material_diffuse_intensity, (PropertyRNA *)&rna_Material_specular_ramp_factor,
...
StructRNA RNA_MaterialTextureSlots = {
	{(ContainerRNA *)&RNA_MaterialRaytraceMirror, (ContainerRNA *)&RNA_Material,
	NULL,
...
StructRNA RNA_MaterialRaytraceMirror = {
	{(ContainerRNA *)&RNA_MaterialRaytraceTransparency, (ContainerRNA *)&RNA_MaterialTextureSlots,
	NULL,
